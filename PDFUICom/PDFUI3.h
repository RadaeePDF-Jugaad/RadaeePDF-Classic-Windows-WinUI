...
winrt::hstring Document_getXMP(PDF_DOC doc);
bool Document_setXMP(PDF_DOC doc, winrt::hstring xmp);
...
winrt::hstring Document_getEFName(PDF_DOC doc, int index);
winrt::hstring Document_getEFDesc(PDF_DOC doc, int index);
bool Document_getEFData(PDF_DOC doc, int index, winrt::hstring path);
int Document_getJSCount(PDF_DOC doc);
winrt::hstring Document_getJSName(PDF_DOC doc, int index);
winrt::hstring Document_getJS(PDF_DOC doc, int index);
...
winrt::hstring Document_getOutlineLabel(PDF_DOC doc, PDF_OUTLINE outlinenode);
...
winrt::hstring Document_getOutlineFileLink(PDF_DOC doc, PDF_OUTLINE outlinenode);
...
winrt::hstring Document_getMeta(PDF_DOC doc, const char* tag);
...
winrt::hstring Document_getPageLabel(PDF_DOC doc, int pageno);
...
winrt::hstring Sign_getIssue(PDF_SIGN sign);
winrt::hstring Sign_getSubject(PDF_SIGN sign);
long Sign_getVersion(PDF_SIGN sign);
winrt::hstring Sign_getName(PDF_SIGN sign);
winrt::hstring Sign_getLocation(PDF_SIGN sign);
winrt::hstring Sign_getReason(PDF_SIGN sign);
winrt::hstring Sign_getContact(PDF_SIGN sign);
winrt::hstring Sign_getModDT(PDF_SIGN sign);
...
winrt::hstring Page_reflowGetText(PDF_PAGE page, int iparagraph1, int ichar1, int iparagraph2, int ichar2);
...
winrt::hstring Page_getAnnotFieldJS(PDF_PAGE page, PDF_ANNOT annot, int idx);
...
winrt::hstring Page_getAnnotJS(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotURI(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnot3D( PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotMovie(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotSound(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotAttachment(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotRendition(PDF_PAGE page, PDF_ANNOT annot);
...
winrt::hstring Page_getAnnotRichMediaItemAsset(PDF_PAGE page, PDF_ANNOT annot, int idx);
winrt::hstring Page_getAnnotRichMediaItemPara(PDF_PAGE page, PDF_ANNOT annot, int idx);
winrt::hstring Page_getAnnotRichMediaItemSource(PDF_PAGE page, PDF_ANNOT annot, int idx);
bool Page_getAnnotRichMediaItemSourceData(PDF_PAGE page, PDF_ANNOT annot, int idx, winrt::hstring save_path);
bool Page_getAnnotRichMediaData(PDF_PAGE page, PDF_ANNOT annot, winrt::hstring asset, winrt::hstring save_path);

winrt::hstring Page_getAnnotFileLink(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotRemoteDest(PDF_PAGE page, PDF_ANNOT annot);
...
winrt::hstring Page_getAnnotPopupSubject(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotPopupText(PDF_PAGE page, PDF_ANNOT annot);
winrt::hstring Page_getAnnotPopupLabel(PDF_PAGE page, PDF_ANNOT annot);
...
winrt::hstring Page_getAnnotEditText(PDF_PAGE page, PDF_ANNOT annot);
...
winrt::hstring Page_getAnnotComboItem(PDF_PAGE page, PDF_ANNOT annot, int item);
...
winrt::hstring Page_getAnnotListItem(PDF_PAGE page, PDF_ANNOT annot, int item);
...
winrt::hstring Page_getAnnotSubmitTarget( PDF_PAGE page, PDF_ANNOT annot );
...
bool Page_addAnnotRichMedia(PDF_PAGE page, winrt::hstring path_player, winrt::hstring path_content, int type, PDF_DOC_IMAGE dimage, const PDF_RECT *rect);
...
winrt::hstring Obj_getTextString(PDF_OBJ hand);
