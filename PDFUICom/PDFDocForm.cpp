...
namespace winrt::RDUILib::implementation
{
    ...
    {
        int64_t hand = (int64_t)Document_addFormResForm(m_doc, m_hand, (PDF_DOC_FORM)sub.Handle());
    ...
    {
        int64_t hand = (int64_t)Document_addFormResFont(m_doc, m_hand, (PDF_DOC_FONT)font.Handle());
    ...
    {
        int64_t hand = (int64_t)Document_addFormResGState(m_doc, m_hand, (PDF_DOC_GSTATE)gs.Handle());
    ...
    {
        int64_t hand = (int64_t)Document_addFormResImage(m_doc, m_hand, (PDF_DOC_IMAGE)img.Handle());
    ...
    {
        Document_setFormContent(m_doc, m_hand, x, y, w, h, (PDF_PAGECONTENT)content.Handle());
    }
}
